...
CASES: list[tuple[str, str | None]] = [
    ...
    ("bugünkü siparişler ne kadar tuttu?", "siparisleri_getir"),
    ("kargoda kaç sipariş var?", "siparisleri_getir"),
    ("Ayşe Yılmaz'ın faturası ödendi mi?", "musteri_faturasi"),
    ("sözleşmelerde fesih geçiyor mu?", "dokuman_ara"),
    ("son commit'te ne değişti?", "son_commit"),
    ("docker'da hangi container'lar çalışıyor?", "docker_listele"),
    ("bugün toplantım var mı?", "takvim_bugun"),
